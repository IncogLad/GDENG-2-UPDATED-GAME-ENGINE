...
public:
	...
	std::vector<Vector3D>* randomizedScene1Positions = new std::vector<Vector3D>();
	std::vector<Vector3D>* randomizedScene2Positions = new std::vector<Vector3D>();
	std::vector<Vector3D>* randomizedScene3Positions = new std::vector<Vector3D>();
	std::vector<Vector3D>* randomizedScene4Positions = new std::vector<Vector3D>();
	std::vector<Vector3D>* randomizedScene5Positions = new std::vector<Vector3D>();
