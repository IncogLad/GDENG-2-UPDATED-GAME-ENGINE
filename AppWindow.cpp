...
void AppWindow::onCreate()
{
	...
	//GameObjectManager::getInstance()->initializeMesh("armadillo");
	//GameObjectManager::getInstance()->initializeMesh("bunny");
	//GameObjectManager::getInstance()->initializeMesh("lucy");
